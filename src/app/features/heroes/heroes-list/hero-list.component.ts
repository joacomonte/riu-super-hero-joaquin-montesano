...
import { HeroIdFilterComponent } from '../../../shared/components/hero-id-filter/hero-id-filter.component';
...
export class HeroListComponent implements OnInit {
  ...
  async onFoundHero(id: number) {
    ...
    try {
      const hero = await this.superHeroService.getHeroByIdFromApi(id);
